  ...
  methods:{
    ...
    buscar: async function(factura){
      ...
      try {
        ...
        let response = await axios.get('http://52.188.153.77:5000/participante_factura/obtener/'+factura.toString());
    ...
    getFacturas: async function(){
      try {
        //se llama el servicio para obtener las emergencias 
        let response = await axios.get('http://52.188.153.77:5000/factura/obtener/id');
