  ...
  methods:{ 
    getEmpresas: async function(){
      try {
        ...
        let response = await axios.get('http://'+process.env.IP_FRONT+':5000/empresa/obtener?');
    ...
    borrarContacto:async function(){
      try{
        let response = await axios.delete('http://'+process.env.IP_FRONT+':5000/contacto/eliminar?id_contacto='+this.contactoEditar.id_contacto)
    ...
    editarEmpresa: async function(item){
      ...
      try{ 
        let response = await axios.put('http://'+process.env.IP_FRONT+':5000/empresa/editar?razon_social='+newEmpresa.razon_social,newEmpresa);
        console.log(response);
        this.close();
    ...
    eliminarEmpresa: async function(){
      try {
        let response = await axios.delete('http://'+process.env.IP_FRONT+':5000/empresa/eliminar?razon_social='+this.editedItem.razon_social);
        console.log(response);
        this.closeDelete();
        Object.assign(this.empresas[this.editedIndex], this.editedItem)
      }
    ...
    getContactos: async function(item){
      try {
        //se llama el servicio para obtener las emergencias 
        let response = await axios.get('http://'+process.env.IP_FRONT+':5000/contacto/obtener?razon_social='+item.razon_social);
    ...
    editarContacto: async function () {
      ...
      try{ 
        let response = await axios.put('http://'+process.env.IP_FRONT+':5000/contacto/editar?id_contacto='+this.contactoEditar.id_contacto,newContacto);
        console.log(response);
    ...
    async createContacto(){ //Crear un nuevo contacto apra empresa
      ...
      let check= await axios.get('http://'+process.env.IP_FRONT+':5000/empresa/obtener?razon_social='+this.razon_social)
      console.log(check.data)
      if (check.data.length==1){
        try {
          //se llama el servicio para crear un nuevo contacto
          let response = await axios.post('http://'+process.env.IP_FRONT+':5000/contacto/agregar',newContacto);
